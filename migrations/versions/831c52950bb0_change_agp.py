...
Revision ID: 831c52950bb0
Revises: 
Create Date: 2018-08-07 17:22:53.008274
...
def upgrade():
    ...
    sa.Column('resume_urls', sa.String(length=64), nullable=True),
    ...
    sa.Column('lowsalary', sa.Integer(), nullable=False),
    sa.Column('highsalary', sa.Integer(), nullable=False),
    ...
    sa.Column('response', sa.String(length=64), nullable=True),
